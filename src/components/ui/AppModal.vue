    ...
    <div v-if="modelValue" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div class="px-8 py-6 flex items-center justify-between border-b border-gray-100 shrink-0 bg-white">
          ...
          <button 
            @click="close"
            class="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-red-50 hover:text-red-500 transition-colors shrink-0 outline-none focus:ring-2 focus:ring-red-500/20"
          >
