export default {
  ...
  "error500": {
    "badge": "Ошибка 500",
    "title": "У нас возникли технические неполадки",
    "desc": "Сервер временно не может обработать ваш запрос. Наши инженеры уже уведомлены и работают над решением проблемы. Пожалуйста, попробуйте обновить страницу через некоторое время.",
