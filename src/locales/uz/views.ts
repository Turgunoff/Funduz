export default {
  ...
  "about": {
    ...
    "team": [
      {
        "name": "Baxtiyor Aliyev",
        "role": "Asoschi va CEO"
      },
      {
        "name": "Nigora Jo'rayeva",
        "role": "Loyihalar rahbari"
      },
      {
      ...
      {
        "name": "Zulayxo Saidova",
        "role": "Hamjamiyat rahbari"
      }
    ],
  ...
  "articles": {
    ...
    "featured": {
      ...
      "title": "'Zamon' 30 kunda qayta tiklanuvchi energiya ta'limi uchun qanday qilib 50,000 dollar to'pladi?",
  ...
  "campaign_story": {
    ...
    "subtitle": "Har bir rekord darajadagi start ortida hamjamiyatni shakllantirish, storytelling va taktik tanqislikning puxta ishlab chiqilgan tizimi yotadi. Biz ushbu loyihani tahlil qilamiz.",
    "author": {
      "name": "Julian Thorne",
      "role": "Bosh strateg",
    ...
    "content_p1": "Zamonaviy loyihalarni moliyalashtirish sohasida 20% darajasida to'xtab qolgan loyiha bilan bir necha soat ichida maqsadidan o'tib ketgan loyiha o'rtasidagi farq faqat mahsulotda emas. Bu birinchi 'Qo'llab-quvvatlash' tugmasi bosilishidan bir necha oy oldin qurilgan hikoya infratuzilmasidadir.",
    ...
    "quote": "Muvaffaqiyatli kampaniyalar mahsulot xususiyatlarini sotmaydi; ular mahsulotga egalik qiluvchi dononing kelajakdagi qiyofasini sotadi.",
    "sidebar": {
    ...
    "discussion": {
      ...
      "join_subtitle": "Fikrlaringizni hamjamiyat bilan baham ko'rish uchun Funduz platformasiga kiring.",
      "sign_in": "Kirish",
  ...
  "pitch_video": {
    ...
    "subtitle": "Sizning videongiz — bu loyihangizning qalbi. Birinchi 10 soniya dononi jalb qilish yoki yo'qotish uchun kifoya. Mana buni qanday qilib to'g'ri qilish kerak.",
    "author": {
      "name": "Malika Saidova",
    ...
    "quote": "Agar siz 2 daqiqada tomoshabinni hayajonlantira olmasangiz, ehtimol siz o'zingiz ham loyihangizga yetarlicha ishonmaysiz.",
    "sidebar": {
      "about": "MUALLIF HAQIDA",
  ...
  "security": {
    ...
    "features": {
      "feat1": {
        "label": "Escrow himoyasi"
      },
      "feat2": {
        "label": "Tasdiqlangan mualliflar"
      },
      "feat3": {
        "label": "Qaytarish kafolati"
      }
    },
    "info_cards": {
      "card1": {
